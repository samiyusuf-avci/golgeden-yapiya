      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {projects.map((project) => {
          ...
          return (
            <div
              key={project.id}
              className={`bg-slate-900/90 border rounded-3xl p-6 transition-all duration-300 flex flex-col justify-between relative group ${
                isSelected
            ...
            >
              ...
              <div className="space-y-2 mb-6 bg-slate-950 p-4 rounded-2xl border border-slate-800/80">
              ...
              <div className="grid grid-cols-2 gap-3 mb-6 text-xs">
                <div className="bg-slate-950 p-3 rounded-xl border border-slate-800/60">
                  <div className="text-[10px] text-slate-400">Toplam Daire / Ünite</div>
                  <div className="font-bold text-white flex items-center gap-1 mt-0.5">
                    <Home className="w-3.5 h-3.5 text-amber-400" />
                    {project.unit_count || 10} Adet Daire
                  </div>
                </div>

                <div className="bg-slate-950 p-3 rounded-xl border border-slate-800/60">
                  <div className="text-[10px] text-slate-400">Proje Bütçesi</div>
                  <div className="font-bold text-white flex items-center gap-1 mt-0.5">
                    {isClientHidden ? (
